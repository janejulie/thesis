public enum SessionPool {
    ...
    Extensive_Fahrt             (2, new int[][]{{0, 0}, {30, 300},  {0, 0}, {0, 0}, {0, 0}, {0, 0}}),
    Fettstoffwechselfahrt       (3, new int[][]{{0, 0}, {60, 300}, {0, 0}, {0, 0}, {0, 0}, {0, 0}}),
    ...
    Freies_Fahrtspiel           (8, new int[][]{{0, 0}, {15, 300},   {15, 300}, {15, 300}, {0, 180}, {0, 180}}),
