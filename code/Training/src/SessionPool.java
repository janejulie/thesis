public enum SessionPool {
    ...
    Fettstoffwechselfahrt       (3, new int[][]{{0, 0}, {180, 360}, {0, 0}, {0, 0}, {0, 0}, {0, 0}}),
    Intensive_Fahrt             (4, new int[][]{{0, 0}, {30, 60},   {15, 60}, {0, 0}, {0, 0}, {0, 0}}),
    Extensive_Kraftausdauerfahrt(5, new int[][]{{0, 0}, {30, 60},   {0, 0}, {0, 0}, {30, 150}, {0, 0}}),
    Einzelzeitfahrt             (6, new int[][]{{0, 0}, {30, 60},   {0, 0}, {30, 60}, {0, 0}, {0, 0}}),
    Extensives_Fahrtspiel       (7, new int[][]{{0, 0}, {15, 240},   {15, 240}, {0, 0}, {0, 0}, {0, 0}}),
    Freies_Fahrtspiel           (8, new int[][]{{0, 180}, {15, 180},   {15, 180}, {15, 180}, {0, 180}, {0, 180}}),
